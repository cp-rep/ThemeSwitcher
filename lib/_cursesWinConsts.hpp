...
const unsigned int _SAVEDFILESWINMINLINES = 16;
...
// _SAVEDFILESWIN DIMENSION CONSTS
const unsigned int _SAVEDTHEMESWINSTARTY = _SAVEDFILESWINSTARTY + _SAVEDFILESWINMAXLINES + 1;
const unsigned int _SAVEDTHEMESWINSTARTX = 3;
const unsigned int _SAVEDTHEMESWINMINLINES = 16;
const unsigned int _SAVEDTHEMESWINMAXLINES = 24;
const unsigned int _SAVEDTHEMESWINMINCOLS = 60;
const unsigned int _SAVEDTHEMESWINMAXCOLS = 120;
